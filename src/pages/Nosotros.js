  ...
  return (
    <main className={styles.pageContainer}>
        <section className={styles.Nosotros}>
            ...
            <p>
                Coffee Beans surge como una Micro-PyME tras hacer realidad las ideas de dos jóvenes entusiastas, quienes a mediados del año 2020 se zambullen en el mundo de cafe mundial, con el fin de brindar un servicio diferencial a través de soluciones y propuestas prácticas, haciendo siempre hincapié en el eslogan "Una opción más... Más que una opción.". Brindando servicios a todo tipo de clientes, de cualquier punto del país, y adaptándonos a sus necesidades.
            </p>
            <p>
